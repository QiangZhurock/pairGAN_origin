...
class GANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        visual_names_A = ['real_Y', 'f', 'real_D']
        # visual_names_B = ['real_X', 'g', 'rec_X']
    ...
    def set_input(self, input):
        ...
        input_Y = input['A'] #this stylized input A
        # input_X = input['B']
    ...
    def backward_G(self):
        ...
        #self.loss_G = self.loss_G_B + self.loss_identity_B + self.loss_MSE_B
        self.loss_G = self.loss_G_B * lambda_G + self.loss_identity_B * eta + self.loss_MSE_B
